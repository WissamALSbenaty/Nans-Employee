...
mixin _$AppSettingsModel {
  ...
  double get androidMinimumVersion => throw _privateConstructorUsedError;
  @JsonKey(name: 'androidLatestVersion')
  double get androidCurrentVersion => throw _privateConstructorUsedError;
...
abstract class $AppSettingsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'minOrderValue') int minimumOrderValue,
      int pointValue,
      @JsonKey(name: 'androidMinVersion') double androidMinimumVersion,
      @JsonKey(name: 'androidLatestVersion') double androidCurrentVersion,
...
class _$_AppSettingsModel extends _AppSettingsModel {
  ...
  @override
  @JsonKey(name: 'androidMinVersion')
  final double androidMinimumVersion;
  @override
  @JsonKey(name: 'androidLatestVersion')
  final double androidCurrentVersion;
  @override
  @JsonKey(name: 'iosMinVersion')
  ...
  @override
  String toString() {
    return 'AppSettingsModel(minimumOrderValue: $minimumOrderValue, pointValue: $pointValue, androidMinimumVersion: $androidMinimumVersion, androidCurrentVersion: $androidCurrentVersion, iosMinimumVersion: $iosMinimumVersion, iosCurrentVersion: $iosCurrentVersion, currency: $currency)';
  }
...
abstract class _AppSettingsModel extends AppSettingsModel {
  factory _AppSettingsModel(
      {@JsonKey(name: 'minOrderValue')
          required final int minimumOrderValue,
      required final int pointValue,
      @JsonKey(name: 'androidMinVersion')
          required final double androidMinimumVersion,
      @JsonKey(name: 'androidLatestVersion')
          required final double androidCurrentVersion,
      @JsonKey(name: 'iosMinVersion')
          required final String iosMinimumVersion,
      @JsonKey(name: 'iosLatestVersion')
          required final String iosCurrentVersion,
      required final String currency}) = _$_AppSettingsModel;
  ...
  @override
  @JsonKey(name: 'androidMinVersion')
  double get androidMinimumVersion;
  @override
  @JsonKey(name: 'androidLatestVersion')
  double get androidCurrentVersion;
  @override
  @JsonKey(name: 'iosMinVersion')
